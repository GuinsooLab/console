  ...
  return (
    <div style={{
      ...
      <div style={{width: '400px', textAlign: 'center', margin: '128px auto',}}>
        <div style={{ background: "linear-gradient(rgb(251, 250, 250) 0%, rgb(228, 228, 228) 100%) 0% 0% no-repeat padding-box padding-box transparent", padding: "40px", color: "rgb(8, 28, 66)" }}>
          <div style={{ width: "100%" }}>
              <svg style={{ width: "100%", height: "100%" }} fill="currentcolor" width="1538px" height="480px" viewBox="0 0 1538 480"
        ...
        <div style={{ backgroundColor: "#ffffff", padding: "40px", color: "rgb(8, 28, 66)" }}>
            ...
            <div style={{
                ...
                <a href="" style={{ color: "rgb(39, 129, 176)", font: "bold 12px / 15px Lato", textDecoration: "none", paddingLeft: 4 }}>➔</a>
            </div>
        </div>
      </div>
    </div>
